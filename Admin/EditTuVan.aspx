<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MP/mpBackEnd.master" AutoEventWireup="true" CodeFile="EditTuVan.aspx.cs" Inherits="Admin_EditTuVan" %>
            ...
            <div class="col-xs-12">
                <section class="panel">
                    <header class="panel-heading">
                        ...
                        <h2 class="panel-title">Sửa tư vấn</h2>
                    </header>
                    <div class="panel-body">
                        <div class="form-horizontal form-bordered">
                            ...
                            <div class="form-group">
                                <label class="col-md-2 control-label"></label>
                                <div class="col-md-3">
                                    <asp:Button Text="Cập nhật" CssClass="btn btn-primary" ID="btnupdatetv" OnClick="btnupdatetv_Click" runat="server" />
                                </div>
                            </div>
                        </div>
                    </div>
