<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MP/mpBackEnd.master" AutoEventWireup="true" CodeFile="insertGioiThieu.aspx.cs" Inherits="Admin_insertGioiThieu" %>
                    ...
                    <div class="panel-body">
                        <div class="form-horizontal form-bordered">
                            ...
                            <div class="form-group">
                                <label class="col-md-2 control-label"></label>
                                <div class="col-md-3">
                                    <asp:Button Text="Insert" CssClass="btn btn-primary" ID="btninsertgt" OnClick="btninsertgt_Click" runat="server" />
                                    <asp:Button Text="Reset" CssClass="btn btn-default" ID="btnresetgt" OnClick="btnresetgt_Click" runat="server" />
                                </div>
                            </div>
                        </div>
                    </div>
