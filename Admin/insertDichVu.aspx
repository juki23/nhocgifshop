<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MP/mpBackEnd.master" AutoEventWireup="true" CodeFile="insertDichVu.aspx.cs" Inherits="Admin_insertDichVu" %>
            ...
            <div class="col-xs-12">
                <section class="panel">
                    <header class="panel-heading">
                        ...
                        <h2 class="panel-title">Thêm dịch vụ</h2>
                    </header>
                    <div class="panel-body">
                        <div class="form-horizontal form-bordered">
                            ...
                            <div class="form-group">
                                <label class="col-md-2 control-label"></label>
                                <div class="col-md-3">
                                    <asp:Button Text="Thêm" CssClass="btn btn-primary" ID="btninsertdv" OnClick="btninsertdv_Click" runat="server" />
                                    <asp:Button Text="Reset" CssClass="btn btn-default" ID="btnresetdv" OnClick="btnresetdv_Click" runat="server" />
                                </div>
                            </div>
                        </div>
                    </div>
